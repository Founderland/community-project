...
const AddUser = ({ setAdd }) => {
  ...
  return (
    <div className="bg-white rounded p-8 flex flex-col w-full shadow-lg">
      <form onSubmit={handleSubmit}>
        ...
        <div className="-mx-3 px-3 flex flex-col-reverse sm:flex-row items-center justify-around">
          <button
            className="px-10 py-2 w-full shadow-lg sm:w-1/3 bg-gray-700 transition duration-200 hover:bg-fblue my-2 text-white"
            onClick={() => {
              setAdd(false)
            }}
          >
