...
const AdminFoundersForm = () => {
    const [listData, setListData] = useState([
        ...
        },
        {
            ...
            answers: [
                ...
                {
                    answer: 'Not in Europe or the UK but planning on relocating to that area',
                    ideal: true,
                    points: 200,
                    notes: '',
        ...
        },
        {
            ...
            question:
                'How long have you been working on your business project? ',
            rank: 'Not Important - just for info/further context',
            type: 'open',
            answers: [
                {
        ...
        },
        {
            ...
            category: 'Tell Us More',
            question:
                'Are you working on this full time or is it a side hustle? ',
            rank: 'Not Important - just for info/further context',
            type: 'open',
            answers: [
                {
        ...
        },
        {
            ...
            category: 'About You',
            question:
                'What is your ethnicity? (If you feel comfortable sharing) ',
            rank: 'Not Important - just for info/further context',
            type: 'open',
            answers: [
                {
    ...
    const headers = [
        { title: 'Question', style: 'text-left' },
        { title: 'Category', style: 'text-left' },
        { title: 'Type', style: 'text-center' },
    ...
    return <div className="w-full">Founders form list</div>
}
