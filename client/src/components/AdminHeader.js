    ...
    return (
        <div className="flex justify-between items-center p-6">
            <div className="flex items-center space-x-4 lg:space-x-0">
                ...
                <div>
                    <h1 className="text-2xl font-medium text-mono text-gray-800 dark:text-white">
                        {view}
                    </h1>
                </div>
            </div>
                ...
                <Menu as="div" className="relative">
                    ...
                    >
                        <Menu.Items className="absolute right-0 mt-2 bg-white w-80 overflow-hidden shadow-xl">
                            <Menu.Item
                                as="button"
                                className="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-fblue hover:text-white"
                            >
                                <UserGroupIcon className="w-4 mr-2" /> 15
                                founders applicants pending review
                            </Menu.Item>
                            <Menu.Item
                                as="button"
                                className="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-fblue hover:text-white"
                            >
                                <ClipboardCheckIcon className="w-4 mr-2" /> 4
                                founders applicants pending approval
                            </Menu.Item>
                        </Menu.Items>
                    </Transition>
                </Menu>
