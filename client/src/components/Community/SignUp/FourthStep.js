...
const FourthStep = ({
  ...
  return accountCreated ? (
    <div className='h-screen w-screen  flex flex-col justify-start lg:justify-center items-center '>
      <div className='flex flex-col p-3 items-center justify-center mt-10 text-grotesk text-xl md:text-2xl xl:text-4xl text-center h-1/4 md:w-4/6 lg:w-2/6 p-2 '>
        <span></span>
