...
const FormPage = (props) => {
  const {submitHandler,previousHandler} = useContext(AnswersContext)
        ...
        <div className=" flex flex-col justify-between  p-10 h-screen">
          ...
          <div className="p-10 ">
            {!isFirst && (
              <button
                type="button"
                className="py-2 px-4 float-left bg-fblue opacity-80 hover:bg-fblue-dark focus:ring-fblue focus:ring-offset-white text-white text-mono w-2/5 md:w-1/3 xl:w-1/4 transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 "
                onClick={previous}
              >
                Prev
              </button>
            ...
            <button
              type="button"
              className={
                "py-2 px-4 float-right focus:ring-offset-white text-white text-mono w-2/5 md:w-1/3 xl:w-1/4 transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 " +
                (isLast
