...
import { InformationCircleIcon, ShieldExclamationIcon, XIcon } from '@heroicons/react/outline'
...
const InfoModal = () => {
	...
	return (
		<Transition appear show={iModal} as={Fragment}>
			<Dialog as="div" onClose={() => setIModal(false)} className="fixed z-10 inset-0 overflow-y-auto">
